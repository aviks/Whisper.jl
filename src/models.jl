...
function register_datadeps()
    ...
    register(DataDep(
        ...
        "https://huggingface.co/datasets/ggerganov/whisper.cpp/resolve/main/ggml-tiny.bin",
    ...
    register(DataDep(
        ...
        "https://huggingface.co/datasets/ggerganov/whisper.cpp/resolve/main/ggml-small.en.bin",
    ...
    register(DataDep(
        ...
        "https://huggingface.co/datasets/ggerganov/whisper.cpp/resolve/main/ggml-small.bin",
    ...
    register(DataDep(
        ...
        "https://huggingface.co/datasets/ggerganov/whisper.cpp/resolve/main/ggml-medium.en.bin",
    ...
    register(DataDep(
        ...
        "https://huggingface.co/datasets/ggerganov/whisper.cpp/resolve/main/ggml-large-v1.bin",
    ...
    register(DataDep(
        ...
        "https://huggingface.co/datasets/ggerganov/whisper.cpp/resolve/main/ggml-large.bin",
